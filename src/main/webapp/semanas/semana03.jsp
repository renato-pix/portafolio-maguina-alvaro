...
<head>
    ...
    <title>Semana 03 - Desarrollo Web</title>
    <style>
        :root {
            --bg-color: #0f172a;
...
<body>
    <div class="container">
        ...
        <h1>Semana 03: Título del Tema</h1>
        <p>Evidencia y material correspondiente a las actividades desarrolladas en la sesión de aprendizaje.</p>
